/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dbff1226f3f9135164bcd549ce501078)
// Runtime types generated with workerd@1.20251210.0 2026-01-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeathchatRoom";
	}
	interface Env {
		HACKCLUB_AI_KEY: string;
		ROOM: DurableObjectNamespace<import("./src/index").DeathchatRoom>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HACKCLUB_AI_KEY">> {}
}
